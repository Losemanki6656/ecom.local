            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6 ">{{ translate('Paymo Credential') }}</h5>
                    </div>
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                            @csrf
                            <input type="hidden" name="payment_method" value="paymo">
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="PAYMO_KEY">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Consumer Key') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="PAYMO_KEY"
                                        value="{{ env('PAYMO_KEY') }}" placeholder="{{ translate('CONSUMER KEY') }}"
                                        required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="PAYMO_SECRET">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Consumer Secret') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="PAYMO_SECRET"
                                        value="{{ env('PAYMO_SECRET') }}" placeholder="{{ translate('CONSUMER SECRET') }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input type="hidden" name="types[]" value="PAYMO_STOREID">
                                    <label class="col-from-label">{{ translate('Store ID') }}</label>
                                    <input type="text" class="form-control" name="PAYMO_STOREID"
                                        value="{{ env('PAYMO_STOREID') }}" placeholder="{{ translate('Store ID') }}"
                                        required>
                                </div>
                                <div class="col-md-6">
                                    <input type="hidden" name="types[]" value="PAYMO_TERMINALID">
                                    <label class="col-from-label">{{ translate('Terminal ID') }}</label>
                                    <input type="text" class="form-control" name="PAYMO_TERMINALID"
                                        value="{{ env('PAYMO_TERMINALID') }}" placeholder="{{ translate('Terminal ID') }}"
                                        required>
                                </div>
                            </div>
