                ...
                <table class="table aiz-table mb-0">
                    ...
                    @foreach ($shops as $key => $shop)
                        <tr>
                            ...
                            <td>
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input onchange="update_billz_status(this)"
                                           value="{{ $shop->id }}" type="checkbox" <?php if ($shop->billz_status == 1) {
                                        echo 'checked';
                                    } ?>
                                    >
                                    <span class="slider round"></span>
                            ...
                            <td>
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input onchange="update_billz_new_status(this)"
                                           value="{{ $shop->id }}"
                                           type="checkbox" <?php if ($shop->billz2_status == 1) {
                                        echo 'checked';
                                    } ?>
                                    >
                                    <span class="slider round"></span>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                        ...
                                        @endcan
                                        @can('paymo_setting')
                                            <a href="{{ route('sellers.paymo-setting', encrypt($shop->id)) }}"
                                               class="dropdown-item">
                        ...
                        <div class="modal fade" id="bankInfo{{$shop->id}}">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title h6">{{ translate("Bank ma'lumotlari") }}</h5>
...
@section('script')
    <script type="text/javascript">
        ...
        function update_billz_status(el) {
            ...
            $.post('{{ route('sellers.billzStatus') }}', {
                _token: '{{ csrf_token() }}',
                id: el.value,
                status: status
            }, function (data) {
                if (data == 1) {
                    AIZ.plugins.notify('success', '{{ translate('Billz status updated successfully') }}');
                } else {
